...
public class Aspersor implements Comparable, Serializable {
    ...
    public void upcount() {
        ...
        if (this.count2 < 10) {//Si el segundo es menor o igual a 10 seguimos sumandole

            if (this.count == 9) {//Cuando count llegue a 9 lo reseteamos 
                this.count = 0;
            }
            this.count++;
